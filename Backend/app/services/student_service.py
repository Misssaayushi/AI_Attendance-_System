...
def enrich_students_with_attendance_stats(db: Session, students: List[models.Student]) -> List[dict]:
    today = datetime.now(ZoneInfo(settings.ATTENDANCE_TIMEZONE)).date()

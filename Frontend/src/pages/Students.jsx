...
import { Search, ChevronLeft, ChevronRight, Filter, Edit, Trash2, Users } from 'lucide-react';
...
const Students = () => {
  ...
  const fetchStudents = async () => {
    setLoading(true);
    try {
      const response = await listStudents({ page: 1, page_size: 100 });
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center space-x-1.5 text-[10px] text-gray-400 font-bold uppercase tracking-wider">
                ...
                <select 
                  ...
                  className="bg-gray-850/50 border border-gray-800/85 text-[10px] text-gray-300 rounded-lg px-2.5 py-1.5 focus:outline-none focus:border-blue-500/50 ml-2"
                >
            ...
            <table className="min-w-full divide-y divide-gray-800">
              <thead className="bg-gray-900/30">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-[10px] font-black text-gray-500 uppercase tracking-widest">Today</th>
                  <th className="px-6 py-4 text-left text-[10px] font-black text-gray-500 uppercase tracking-widest">Arrival</th>

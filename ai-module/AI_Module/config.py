...
ATTENDANCE_UNRECOGNIZED_ENDPOINT = os.getenv("ATTENDANCE_UNRECOGNIZED_ENDPOINT", "/api/v1/attendance/unrecognized")
ATTENDANCE_UNRECOGNIZED_URL = f"{API_BASE_URL.rstrip('/')}{ATTENDANCE_UNRECOGNIZED_ENDPOINT}"
